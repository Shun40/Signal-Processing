class ADConverter
	# 外部ファイル読み込み
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/ADConverter/ADConverterDisplay.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/FunctionGenerator/FunctionGenerator.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/SamplingParameter/SamplingParameter.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/ADConverterDevice/SamplingDevice.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/ADConverterDevice/QuantizationDevice.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/ADConverterDevice/EncodingDevice.rb';
	# 必要なモジュールの読み込み
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/CalcModule.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/ADConverter/ADConverterCalcModule.rb';
	include CalcModule;
