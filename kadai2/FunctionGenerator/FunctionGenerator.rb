class FunctionGenerator
	# 外部ファイル読み込み
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/FunctionGenerator/FunctionGeneratorDisplay.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/SinWave/SinWaveParameter.rb';
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/WhiteNoise/WhiteNoiseParameter.rb';
	# 必要なモジュールの読み込み
	require 'F:/5IKoukiMemory/SignalProcessing/Program/Kadai2/FunctionGenerator/FunctionGeneratorCalcModule.rb';
